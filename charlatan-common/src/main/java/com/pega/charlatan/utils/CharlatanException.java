...
public abstract class CharlatanException extends Exception {
    /**
     ...
     *  the caller.
     */
    public static CharlatanException create(Code code, String path) {
        CharlatanException r = create(code);
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static CharlatanException create(int code, String path) {
        CharlatanException r = create(Code.get(code));
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static CharlatanException create(int code) {
     ...
     * the caller.
     */
    public static CharlatanException create(Code code) {
        switch (code) {
            case SYSTEMERROR:
    ...
    public CharlatanException(Code code) {
        this.code = code;
    }

    CharlatanException(Code code, String path) {
        this.code = code;
        this.path = path;
    }
     ...
     *  @see Code#APIERROR
     */
    public static class APIErrorException extends CharlatanException {
     ...
     *  @see Code#AUTHFAILED
     */
    public static class AuthFailedException extends CharlatanException {
     ...
     */
    public static class BadArgumentsException extends CharlatanException {
     ...
     * @see Code#BADVERSION
     */
    public static class BadVersionException extends CharlatanException {
     ...
     */
    public static class ConnectionLossException extends CharlatanException {
     ...
     */
    public static class DataInconsistencyException extends CharlatanException {
     ...
     * @see Code#INVALIDACL
     */
    public static class InvalidACLException extends CharlatanException {
     ...
     */
    public static class InvalidCallbackException extends CharlatanException {
     ...
     */
    public static class MarshallingErrorException extends CharlatanException {
     ...
     * @see Code#NOAUTH
     */
    public static class NoAuthException extends CharlatanException {
     ...
     */
    public static class NoChildrenForEphemeralsException extends CharlatanException {
     ...
     * @see Code#NODEEXISTS
     */
    public static class NodeExistsException extends CharlatanException {
     ...
     * @see Code#NONODE
     */
    public static class NoNodeException extends CharlatanException {
     ...
     * @see Code#NOTEMPTY
     */
    public static class NotEmptyException extends CharlatanException {
     ...
     */
    public static class OperationTimeoutException extends CharlatanException {
     ...
     */
    public static class RuntimeInconsistencyException extends CharlatanException {
     ...
     */
    public static class SessionExpiredException extends CharlatanException {
     ...
     */
    public static class SessionMovedException extends CharlatanException {
     ...
     */
    public static class NotReadOnlyException extends CharlatanException {
     ...
     */
    public static class SystemErrorException extends CharlatanException {
     ...
     */
    public static class UnimplementedException extends CharlatanException {
     ...
     * @see Code#NOWATCHER
     */
    public static class NoWatcherException extends CharlatanException {

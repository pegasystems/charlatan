...
public interface IZkConnection {
    ...
    String create(String path, byte[] data, List<ACL> acl, CreateMode mode) throws KeeperException;
    ...
    List<String> getChildren(final String path, final boolean watch) throws KeeperException;
